...
def render_html(result: AuditResult) -> str:
    ...
    finding_rows = "".join(
        ...
        <p>{html.escape(finding.rationale)}</p><p><b>Remediation:</b> {html.escape(finding.suggestion)}</p></details></td>
...
<div style="overflow:auto"><table><thead><tr><th>Severity</th><th>Rule</th><th>Mode</th><th>Finding</th><th>Location</th></tr></thead><tbody id="findings">{finding_rows}</tbody></table></div></section></main>
